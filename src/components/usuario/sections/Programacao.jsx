...
import { TIPO_COLOR, nomeExibicao, formatData, diaSemana } from "../../../utils/helpers";
    ...
    <div>
      ...
      {event.programacao_visivel === false ? (
        ...
        <div className="prog-dias-grid">
          {dias.map(dia => (
            <div key={dia} className="prog-dia-col">
              <div className="prog-dia-col-titulo">{diaSemana(dia)}, {formatData(dia)}</div>
