...
export const DEFAULT_MENSAGEM_CERTIFICADO = "Seu certificado de participação já está disponível! Clique no botão abaixo para acessar.";

export function gerarTemplateHTMLCertificado({ event, bannerUrl, certificadoUrl, assunto, mensagem, corCabecalho, corRodape, corBotao, ctaTexto }) {
  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      ...
      <tr><td style="padding:40px 48px;">
        <p style="font-size:15px;color:#4a5568;line-height:1.7;margin:0 0 28px;white-space:pre-line;">${mensagem || DEFAULT_MENSAGEM_CERTIFICADO}</p>
