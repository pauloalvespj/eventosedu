-- Confirmação de presença via QR (atividade e turno) passa a aceitar
-- CPF OU e-mail como identificador de quem não está logado — antes só
-- aceitava CPF. Mantém o nome do parâmetro (p_cpf) para não quebrar as
-- chamadas RPC existentes; internamente ele agora é tratado como
-- "cpf ou e-mail".
